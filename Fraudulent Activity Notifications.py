...
#         # print(len(expenditure)-1)
#         tmp_arr = expenditure[:d]
#         if expenditure[d]<=200:
#             median_exp = median(tmp_arr)
#             if expenditure[d]>= float(median_exp*2):
#                 count+=1
#         else:
#             count+=1
#         # 926
#         # print(expenditure, tmp_arr, expenditure[d])
#         expenditure.pop(0)
#     return count       
